#!/usr/bin/env python3
"""주간 보고서 생성기 (Backward Compatibility Wrapper)
...
class WeeklyReportGenerator(ReportGenerator):
    ...
    내부적으로 ReportGenerator(report_type='weekly')를 사용합니다.
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(description="주간 보고서 생성기 (BGE-M3 + GPT-4.1)")
    ...
    if args.output:
        ...
        default_output = f"data/reports/weekly_report_{timestamp}.json"
